...
## Project Structure
    ...
    ├── cold_wildflower_dev_81887  # Django project configurations
...
1. Clone this repo and `cd cold_wildflower_dev_81887`
...
2. Clone this repo and `cd cold_wildflower_dev_81887`
